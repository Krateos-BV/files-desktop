...
./linuxdeploy-squashfs-root/AppRun --desktop-file=${DESKTOP_FILE} "--icon-file=usr/share/icons/hicolor/512x512/apps/${APPICON_NAME}.png" --executable=usr/bin/${EXECUTABLE_NAME} --appdir=AppDir
=======
