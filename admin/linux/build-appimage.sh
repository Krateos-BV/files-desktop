...
export APPICON_NAME=${APPICON_NAME:-Nextcloud}
...
./linuxdeploy-squashfs-root/AppRun --desktop-file=${DESKTOP_FILE} "--icon-file=usr/share/icons/hicolor/512x512/apps/${APPICON_NAME}.png" --library=${OPENVFS_VFS_PLUGIN} --executable=usr/bin/${EXECUTABLE_NAME} --appdir=AppDir
...
./linuxdeploy-squashfs-root/AppRun --desktop-file=${DESKTOP_FILE} \
	...
	"--icon-file=usr/share/icons/hicolor/512x512/apps/${APPICON_NAME}.png" --executable=usr/bin/${EXECUTABLE_NAME} --appdir=AppDir --output appimage
